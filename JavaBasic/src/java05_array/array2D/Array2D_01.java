...
public class Array2D_01 {
	public static void main(String[] args) {
		...
		int[][] arr2D;	//int2차원배열 변수 선언 	-> int형배열 여러 개 저장
						// -> ((정수값)의 여러 개 묶음) 을 한번 더 여러 개로 포장한 것
		
		int[][][] arr3D;		//int형 3차원 배열 변수
		int[][][][] arr4D;		//int형 4차원 배열 변수
		int[][][][][] arr5D;	//int형 5차원 배열 변수
		// arr2D ~ arrND; -> 다차원, 고차원 배열이라고 함
...
//		arr[0] = new int[3];
		...
		int[] arr2;		//추천
		int arr3[];		//비추천 -> int형배열이 아닌 int형으로 인식하게 된다. 문법상으로는 문제가 없다.
		
		int[][] arr4;	//추천
		int[] arr5[];	//비추천
		int arr6[][];	//비추천
		
		int[][]arr7;	//자료형과 변수사이에 기호가 없어도, 자바는 인식하지만 사람은 보기가 좋지 않다.
