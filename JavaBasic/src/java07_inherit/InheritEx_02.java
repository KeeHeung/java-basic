...
class Child2 extends Parent2{
	public int num;			//상속받은 멤버필드
	
	public String name;		//자식클래스의 고유 멤머필드
...
public class InheritEx_02 {
	public static void main(String[] args) {
		...
		//에러, Parent2 타입에 print()맴버메소드가 존재하지 않는다
//		pc.print();
		
		((Child2)pc).print(); //Child2 타입으로 강제 형변환
