...
public class Unary_02 {
	...
	public static void main(String[] args) {
		...
		// 증감 연산자는 다른 연산식과 함꼐 사용할 때 계산 방법이 달라진다
		...
		System.out.println( num ); // 15
		System.out.println( num-- );//15	//감소연산자 적용, 후치 감소, 후위 감소
		...
		System.out.println( num ); //15
		System.out.println( --num );//14	//감소연산자 적용, 전치 감소, 전위 감소
		System.out.println( num );//14
		
		//	** 전위 증감연산자는 변수의 값을 불러오기 전에 변수의 값을 증감시킨다
		//	** 후위 증감연산자는 변수의 값을 불러오기 전에 변수의 값을 증감시킨다
