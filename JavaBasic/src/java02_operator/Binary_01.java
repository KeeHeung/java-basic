...
//		result = 4;
		...
		System.out.println("우선순위"+num1+num2);
//		System.out.println("우선순위"+num1-num2);	//에러, +는 출력문에서 문자열을 붙여주는 역할,
													//		-는 연산기호로 사용된다
...
//		System.out.println("num1 + num2 = 166");
		...
		// 우선순위를 ()로 지정하여 줌으로서 원하는 결과값을 얻어 냄
		System.out.println("num1 + num2 = " + (num1 + num2));
		System.out.println("num1 - num2 = " + (num1 - num2));
		System.out.println("num1 * num2 = " + (num1 * num2));
...
//		System.out.println( 16 / (double)num2);		
