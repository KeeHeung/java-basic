...
//		Map map = new HashMap();
		...
		System.out.println( map.get(true) );	//3.234
		
		
		System.out.println();
		System.out.println("--- 중복된 키(key)------");
		...
		System.out.println();
		System.out.println("--- 중복된 값(value)------");
		...
		System.out.println("크기 : " + map.size() );	//4 -> 4쌍

		System.out.println();
		System.out.println("--- isEmpty() ------");

		System.out.println("비었는가? : " + map.isEmpty() );	//false
