...
//		prop.setProperty("A", 100);
		...
		try {
			...
			//파일 출력 스트립 생성
			//	-> 파일이 없을 경우 파일도 생성해준다
//			writer = new FileWriter("C:\\Users\\heung\\git\\repository\\JavaBasic\\src\\java10_collection\\user.properties");
			writer = new FileWriter("C:/Users/heung/git/repository/JavaBasic/src/java10_collection/user.properties");
		...
		try {
			...
			//파일 입력 스트림 생성
			reader = new FileReader("C:/Users/heung/git/repository/JavaBasic/src/java10_collection/user.properties");
