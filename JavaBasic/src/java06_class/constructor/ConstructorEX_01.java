...
public class ConstructorEX_01 {
	public static void main(String[] args) {
		...
		//객체 생성_01
		cons_01 = new Constructor(); //생성자 호출
		
		//에러, private 필드에 접근할 수 없다
//		cons_01.num1 = 5000;
		
		System.out.println("--- 생성자_01 호출 후 ---");
		System.out.println("num1: " + cons_01.getNum1() + ", num2: " + cons_01.getNum2());
		...
		System.out.println("--- 생성자_02 호출 후 ---");
